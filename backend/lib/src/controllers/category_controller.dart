...
class CategoryController {
  ...
  final DbCollection _categoryCollection;
  ...
  CategoryController(
    ...
    Db db,
        ...
        _categoryCollection = db.collection('categories') {
    handle();
  }
  ...
  Future<void> handleGet() async {
    var _result = await _categoryCollection.find().toList();
    _request.response.write(json.encode(_result));
  }

  Future<void> handlePost() async {
    var _result = await _categoryCollection
  ...
  Future<void> handleDelete() async {
    ...
    var _result = await _categoryCollection.remove(where.eq('_id', _id));
    _request.response.write(json.encode(_result));
  }
